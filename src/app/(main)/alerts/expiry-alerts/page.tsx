...
const expiryAlerts: ExpiryAlert[] = [
  {
    ...
    documentNumber: "DOC-2023-AMX-001",
    quantity: 50,
    unit: "علبة",
    category: "أدوية",
  ...
  },
  {
    ...
    documentNumber: "DOC-2024-MLK-015",
    quantity: 120,
    unit: "علبة",
  ...
  },
  {
    ...
    documentNumber: "DOC-2024-CLR-008",
    quantity: 85,
    unit: "عبوة",
  ...
  },
  {
    ...
    documentNumber: "DOC-2024-PAN-023",
    quantity: 200,
    unit: "علبة",
    category: "أدوية",
    supplier: "شركة الأدوية الوطنية",
  ...
  },
  {
    ...
    documentNumber: "DOC-2024-RSE-042",
    quantity: 75,
    unit: "كيس",
    category: "مواد غذائية",
    supplier: "شركة المواد الغذائية المتحدة",
  ...
  },
  {
    ...
    documentNumber: "DOC-2023-VIT-019",
    quantity: 30,
    unit: "علبة",
    category: "أدوية",
    supplier: "شركة الأدوية الوطنية",
  ...
  },
  {
    ...
    documentNumber: "DOC-2024-SGR-031",
    quantity: 100,
    unit: "كيس",
    category: "مواد غذائية",
    supplier: "شركة المواد الغذائية المتحدة",
  ...
  },
  {
    ...
    documentNumber: "DOC-2024-DIS-012",
    quantity: 45,
    unit: "عبوة",
    category: "مواد كيميائية",
    supplier: "مؤسسة العراق للتجارة العامة",
  ...
  },
  {
    ...
    documentNumber: "DOC-2024-OIL-025",
    quantity: 60,
    unit: "علبة",
    category: "مواد غذائية",
    supplier: "شركة المواد الغذائية المتحدة",
  ...
  },
  {
    ...
    documentNumber: "DOC-2024-INS-007",
    quantity: 25,
    unit: "قلم",
    category: "أدوية",
    supplier: "شركة الأدوية الوطنية",
