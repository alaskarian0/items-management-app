...
const DepartmentBalancePage = () => {
    ...
    if (!selectedWarehouse) {
        return (
            <Card>
                <CardHeader>
                    <CardTitle>رصيد الأقسام</CardTitle>
                </CardHeader>
                <CardContent className="space-y-4">
                    <Alert>
                        <AlertCircle className="h-4 w-4" />
                        <AlertDescription>
                            الرجاء اختيار المخزن لعرض رصيد الأقسام
                        </AlertDescription>
                    </Alert>
                    <WarehouseSelector />
                </CardContent>
        ...
        <Card>
            ...
            <CardContent>
                <p className="text-muted-foreground text-center py-8">
                    سيتم إضافة محتوى رصيد الأقسام قريباً...
                </p>
            </CardContent>
        </Card>
    );
...
export default DepartmentBalancePage;
